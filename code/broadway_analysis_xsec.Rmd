...
df %>%
  ...
  geom_histogram(bins= 20, col="white")+
  labs(x = "Percentage of pottention revenue", y = "Count", title = "Distribution of % of potential revenue") +
  theme_bw()
```
...
row.names(t_and_t_compare) <- c("Intercept", "Occupancy Percentage", "Percentage of pott. revenue", 
